    ...
    <div class="as-panel">
        <div class="as-panel-header">
            ...
            <div class="as-action-button">
                <button type="button" class="as-btn as-btn-green as-save-settings" data-id="<?php echo $id; ?>"><i class="fa fa-save"></i> <span><?php _e('Save Settings', 'avartan-slider-lite'); ?></span></button>
                <button type="button" class="as-btn as-btn-orange as-preview-slider as-pro-version"><i class="fa fa-search"></i> <span><?php _e('Preview', 'avartan-slider-lite'); ?></span></button>
                <button id="delete_as_slider_<?php echo $id; ?>" type="button" class="as-btn as-btn-red as-delete-slider"><i class="fa fa-trash"></i> <span><?php _e('Delete Slider', 'avartan-slider-lite'); ?></span></button>
                <button type="button" onclick="location.href='?page=avartanslider';" class="as-btn as-btn-blue" title="<?php esc_attr_e('All Slider', 'avartan-slider-lite'); ?>"><i class="fa fa-list"></i> <span><?php _e('All Slider', 'avartan-slider-lite'); ?></span></button>
            </div>
        </div>
                        ...
                        foreach ($slider_nav_array as $key => $value) {
                            ...
                            <li class="ui-state-default">
                                <a href="#as-slider-<?php echo $key; ?>" class="<?php if($key == 'parallax' || $key == 'callbacks'){ echo 'as-pro-version'; } ?>">
                                    <span class="fa <?php echo $value['icon']; ?>"></span>
                                    <?php echo $value['name']; ?>
                                </a>
                            </li>
                            <?php
