...
<div class="as-form as-form-horizontal as-animation-text-div">
    <div class="as-form-control-group">
        ...
        <div class="as-form-control">
            <input class="as-slide-slot-amount as-text-number as-pro-version" type="text" readonly="readonly" value="<?php echo $slot_amount; ?>" onkeypress="return avsIsNumberKey(event);" min="0">
        </div>
    </div>
    <div class="as-form-control-group">
        <label><?php _e('Slot Rotation', 'avartan-slider-lite'); ?></label>
        <div class="as-form-control">
            <input class="as-slide-slot-rotation as-text-number as-pro-version" type="text" readonly="readonly" value="<?php echo $slot_rotation; ?>" onkeypress="return avsIsNumberKey(event);" min="0">
    ...
    <div class="as-form-control-group">
        ...
        <div class="as-form-control">
            <input class="as-slide-animation-time as-text-number" type="text" value="<?php echo $data_time; ?>" onkeypress="return avsIsNumberKey(event);" min="0">
    ...
    <div class="as-form-control-group">
        ...
        <div class="as-form-control">
            <input class="as-slide-animation-easyin as-text-number" type="text" value="<?php echo $data_easeIn; ?>" onkeypress="return avsIsNumberKey(event);" min="0">
            <span class="lbl_px">ms</span>
        </div>
...
<div class="as-animation-effect">
    <div class="slide-trans-example">
        ...
        <span>Animation Effect will be shown in pro version</span>
    </div>
