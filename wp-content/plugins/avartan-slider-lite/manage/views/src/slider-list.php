    ...
    <div class="as-slide-tab-name">
        <div class="as-slider-detail">
            ...
            <div class="as-slider-shortcode">
                <input class="as-shortcode-selection" type="text" value="[avartanslider alias='<?php echo $slider->getAlias(); ?>']" onclick="this.select();" readonly="readonly">
            </div>
        ...
        <div class="as-slide-action">
            ...
            <a class="as-btn as-slide-tab-btn" href="?page=avartanslider&view=slide&id=<?php echo $slider->getFirstSlideId($slider->getId()); ?>" title="<?php esc_attr_e('Edit Slides', 'avartan-slider-lite'); ?>">
