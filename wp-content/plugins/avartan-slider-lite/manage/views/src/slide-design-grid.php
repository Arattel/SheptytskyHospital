    ...
    <div class="as-panel-body">
        <div class="as-editor-header">
            <div class="as-editor-tabs">
                <ul>
                    <li><a href="#as_editor_design"><span class="fa fa-pencil-square-o"></span><?php _e('Design', 'avartan-slider-lite'); ?></a></li>
                    <li><a href="#as_editor_animation"><span class="fa fa-pencil-square-o"></span><?php _e('Animation', 'avartan-slider-lite'); ?></a></li>
                    <li><a href="#as_editor_attributesLink"><span class="fa fa-wrench"></span><?php _e('Attributes & Link', 'avartan-slider-lite'); ?></a></li>
                    <li><a href="#as_editor_advanced"><span class="fa fa-link"></span><?php _e('Advanced', 'avartan-slider-lite'); ?></a></li>
                    <li><a href="#as_editor_parallax"><span class="fa fa-paragraph"></span><?php _e('Parallax / 3D', 'avartan-slider-lite'); ?></a></li>
                </ul>
                <div class="as-editor-tabs-content">
                    ...
                    <div class="as-tab-info" id="as_editor_design">
                        <div class="as-editor-design-block as-editor-form-inline">
                            <div class="as-editor-design-row as-image-layer-hide as-video-layer-hide as-shape-layer-hide as-button-layer-hover-hide">
                                <div class="as-form-control-group as-icon-layer-hide">
                                ...
                                <div class="as-form-control-group">
                                    ...
                                    <div class="as-form-control">
                                        <input type="text" min="0" step="1" value="20" readonly="readonly" class="as-slide-font-size as-text-number as-pro-version" title="<?php esc_attr_e('Font Size', 'avartan-slider-lite'); ?>" onkeypress="return avsIsNumberKey(event);" style="width: 68px;" /><span class="lbl_px">px</span>
                                    </div>
                                </div>
                                <div class="as-form-control-group">
                            ...
                            <div class="as-editor-design-row">
                                <div class="as-form-control-group as-image-layer-hide as-video-layer-hide as-shape-layer-hide as-button-layer-hover-hide">
                                    <div class="as-form-control as-pro-version">
                                ...
                                <div class="as-form-control-group">
                                    <div class="as-form-control as-pro-color as-image-layer-hide as-video-layer-hide as-shape-layer-hide">
                                        <input type="text" readonly="readonly" value="#000000" class="as-font-color as-color-picker" data-alpha="true" data-custom-width="0" title="<?php esc_attr_e('Font Color', 'avartan-slider-lite'); ?>"/>
                                    </div>
                                    <div class="as-form-control as-pro-color">
                                        <input type="text" readonly="readonly" value="" class="as-background-color as-color-picker" data-alpha="true" data-custom-width="0" title="<?php esc_attr_e('Background Color', 'avartan-slider-lite'); ?>"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="as-editor-design-block as-editor-form-inline">
                            ...
                            <div class="as-editor-design-row as-button-layer-hover-hide">
                                <div class="as-form-control-group">
        ...
        <div class="as-editor-content-area_wrap">
            <input type="hidden" name="slider_width" class="as-slider-mobile-width" value="<?php echo $mobile_width; ?>">
            <input type="hidden" name="slider_mobile_height" class="as-slider-mobile-height" value="<?php echo $mobile_height; ?>">
            <input type="hidden" name="slider_width" class="as-slider-width" value="<?php echo $desktop_width; ?>">
            <input type="hidden" name="slider_height" class="as-slider-height" value="<?php echo $desktop_height; ?>">
        ...
        <div class="as-editor-footer">
            <div class="as-editor-footer-menu as-layer-menu">
                <div class="as-editor-addNewLayer">
                    <a href="javascript:void(0);" title="<?php esc_attr_e('Add New Layer', 'avartan-slider-lite'); ?>"><i class="fa fa-database"></i> <?php _e('Add New Layer', 'avartan-slider-lite'); ?></a>
                    <ul>
                        <li><a class="as-add-text-element"><i class="fa fa-text-width"></i> <span><?php _e('Text/HTML', 'avartan-slider-lite'); ?></span></a></li>
                        <li><a class="as-add-image-element"><i class="fa fa-image"></i> <span><?php _e('Image', 'avartan-slider-lite'); ?></span></a></li>
                        <li><a class="as-add-video-element"><i class="fa fa-video-camera"></i> <span><?php _e('Video', 'avartan-slider-lite'); ?></span></a></li>
                        <li><a class="as-add-shortcode-element as-pro-version"><i class="fa fa-code"></i> <span><?php _e('Shortcode', 'avartan-slider-lite'); ?></span></a></li>
                        <li><a class="as-add-button-element as-pro-version"><i class="fa fa-square-o"></i> <span><?php _e('Button', 'avartan-slider-lite'); ?></span></a></li>
                        <li><a class="as-add-icon-element as-pro-version"><i class="fa fa-th"></i> <span><?php _e('Icon', 'avartan-slider-lite'); ?></span></a></li>
                        <li><a class="as-add-shape-element as-pro-version"><i class="fa fa-clone"></i> <span><?php _e('Shape', 'avartan-slider-lite'); ?></span></a></li>
                    </ul>
                </div>
                <div class="as-editor-layer-detail">
                    ...
                    <div class="as-layer-video-element">
                        <div class="as-tab-video-element">
                            <ul>
                                <li><a href="#as_tab_video_sources"><i class="fa fa-random"></i> <?php _e('Sources', 'avartan-slider-lite'); ?></a></li>
                                <li><a href="#as_tab_video_settings"><i class="fa fa-gear"></i> <?php _e('Settings', 'avartan-slider-lite'); ?></a></li>
                                <li><a href="#as_tab_video_preview"><i class="fa fa-search"></i> <?php _e('Preview', 'avartan-slider-lite'); ?></a></li>
                            </ul>
                                    ...
                                    <div class="as-form as-editor-form-horizontal">
                                        ...
                                        <div class="as-video-type-youtube">
                                            ...
                                            <div class="as-form-control-group">
                                                ...
                                                <span><?php _e('Example', 'avartan-slider-lite'); ?>: iNJdPyoqt8U </span>
                                            </div>
                                        </div>
            ...
            <div class="as-editor-action-icon">
                <button class="as-btn as-edit-layer as-btn-disabled" title="<?php esc_attr_e('Edit Layer', 'avartan-slider-lite'); ?>" disabled="disabled" ><i class="fa fa-pencil"></i></button>
                <button class="as-btn as-duplicate-layer as-btn-disabled" title="<?php esc_attr_e('Duplicate Layer', 'avartan-slider-lite'); ?>"><i class="fa fa-paste"></i></button>
                <button class="as-btn as-delete-layer as-btn-disabled" title="<?php esc_attr_e('Delete Layer', 'avartan-slider-lite'); ?>"><i class="fa fa-trash"></i></button>
            </div>
            <div class="as-pull-right">
                ...
                <div class="as-editor-responsive-icon">
                    <a href="javascript:void(0);" class='as-editor-mobile-icon as-pro-version' title="<?php esc_attr_e('Mobile View', 'avartan-slider-lite'); ?>"><i class="fa fa-mobile"></i></a>
                    <a href="javascript:void(0);" class="as-editor-desktop-icon as-active" title="<?php esc_attr_e('Desktop View', 'avartan-slider-lite'); ?>"><i class="fa fa-desktop"></i></a>
                </div>
                <?php
                }
                ?>
                <div class="as-editor-footer-menu as-snapto-menu">
                    <a href="javascript:void(0);" title="<?php esc_attr_e('Snap To', 'avartan-slider-lite'); ?>"><i class="fa fa-align-justify"></i>  <?php _e('Snap to', 'avartan-slider-lite'); ?></a>
                    <ul>
                ...
                <div class="as-editor-footer-menu as-grid-helper-menu">
                    <a href="javascript:void(0);" title="<?php esc_attr_e('Grid Helper', 'avartan-slider-lite'); ?>"><i class="fa fa-th-large"></i> <?php _e('Grid Helper', 'avartan-slider-lite'); ?></a>
                    <ul>
