...
define('AVARTAN_LITE_PLUGIN_URL', plugins_url() . '/avartan-slider-lite');
...
class avsLiteFront {
    ...
    public function __construct() {
        ...
        add_filter('plugin_action_links_' . plugin_basename(__FILE__), array('avsLiteFront', 'avsPluginActionLink'));
    ...
    /**
     * Add documentation link in plugin listing page
     * 
     * @since 1.3
     * @param array $links
     * @return string
