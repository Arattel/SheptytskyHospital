...
class AvartansliderLiteShortcode {
    ...
    */
                ...
                switch ($element_type) {
                    ...
                    case 'video':
                        ...
                        if($ele_video_type == 'html5'){
                            ...
                            if($html5_ogv_url != ''){
                                $ele_video_settings .= ' data-video-webm="' . trim($html5_ogv_url) . '"';
                            }
                            if($html5_webm_url != ''){
                                $ele_video_settings .= ' data-video-ogv="' . trim($html5_webm_url) . '"';
                            }
    ...
    public function avsSliderOutput($alias, $echo, $preview=false) {        
        ...
        if (!$slider) {
            if ($echo) {
                _e( 'The slider hasn not been found', 'avartan-slider-lite' );
                return;
            } else {
